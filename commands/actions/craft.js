...
module.exports = {
  ...
  async execute(
    ...
    try {
      ...
      let pageslice = craftingtable_mapData.slice(display_start, display_end);
      ...
      craft_msg_embed.setDescription(
        `${craftingtable_map.slice(display_start, display_end).join("\n\n")}`
      );
      ...
      collector.on("collect", async (i) => {
        ...
        if (i.customId === "endinteraction") {
          ...
          pageslice = craftingtable_mapData.slice(display_start, display_end);
          ...
          row.setComponents([setminbutton, sethalfbutton, setmaxbutton]);
          ...
          setminbutton.setLabel(`Set Min (0)`);
